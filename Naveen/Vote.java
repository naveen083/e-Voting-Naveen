...
public void init()
 ...
 count8 =0;
  ...
  Checkbox ch1 =new Checkbox("DMK");     
     Checkbox ch2 =new Checkbox("Congress");     
     Checkbox ch3 =new Checkbox("ADMK");
  Checkbox ch4 =new Checkbox("BJP");
  Checkbox ch5 =new Checkbox("DMDK");
  Checkbox ch6 =new Checkbox("PMK");
  Checkbox ch7 =new Checkbox("NTK");
  Checkbox ch8=new Checkbox("Youth Party");

 anc = new TextField(""  + String.valueOf(count1));
 anc.setEditable(false);
    np = new TextField("" + String.valueOf(count2));
 np.setEditable(false);

 dp = new TextField(""  + String.valueOf(count3));
 dp.setEditable(false);

 ifp = new TextField("" +  String.valueOf(count4));
 ifp.setEditable(false);

 pac = new TextField("" +  String.valueOf(count5));
 pac.setEditable(false);


 azapo = new TextField("" + String.valueOf(count6));
 azapo.setEditable(false);

 kiss = new TextField(""  + String.valueOf(count7));
 kiss.setEditable(false);

 udm = new TextField(""  + String.valueOf(count8));
...
class SingleAction implements ActionListener
{
 public void actionPerformed(ActionEvent e)
 {
  ...
  anc.setText("" + String.valueOf(count1));
  np.setText("" + String.valueOf(count2)); 
  pac.setText("" + String.valueOf(count3)); 
  dp.setText("" + String.valueOf(count4)); 
  udm.setText("" + String.valueOf(count5)); 
  kiss.setText("" + String.valueOf(count6)); 
  ifp.setText("" + String.valueOf(count7)); 
  azapo.setText("" + String.valueOf(count8)); 
